...
const Contact: React.FC = () => (
  <main className="max-w-3xl mx-auto py-12 px-4">
    ...
    <ul className="text-gray-700 mb-4">
      <li><strong>Email:</strong> <a href="mailto:support@unitywithin.example.com" className="text-unity-500 underline">support@unitywithin.example.com</a></li>
      <li><strong>Instagram:</strong> <a href="https://www.instagram.com/unitywithin" className="text-unity-500 underline">@unitywithin</a></li>
