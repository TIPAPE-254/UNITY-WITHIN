export type ViewState = 'landing' | 'login' | 'signup' | 'dashboard' | 'wellness' | 'chat' | 'journal' | 'breathe' | 'education' | 'admin' | 'explore' | 'resources' | 'profile' | 'volunteer' | 'volunteer-invite' | 'volunteer-dashboard' | 'volunteer-portal' | 'admin-volunteers';
