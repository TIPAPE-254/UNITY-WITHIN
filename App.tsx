...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#FFF5F7] flex flex-col md:flex-row text-unity-black font-sans selection:bg-unity-200 selection:text-unity-900">
      ...
      {/* Sidebar (Desktop) - Hidden on landing page */}
      {currentView !== 'landing' && (
          ...
          <div className="mt-auto pt-6 border-t border-gray-100">
              <div className="flex items-center gap-3">
                  ...
                  <div className="text-sm">
                      <p className="font-bold text-unity-black">User Account</p>
      ...
      {/* Main Content Area */}
      <main className={`${currentView === 'landing' ? 'w-full' : 'flex-1 md:ml-64'} p-4 pb-24 md:p-8 md:pb-8 max-w-5xl mx-auto w-full transition-all`}>
         {/* Mobile Header - Hidden on landing page */}
         {currentView !== 'landing' && (
      ...
      {/* Bottom Navigation (Mobile) - Hidden on landing page */}
      {currentView !== 'landing' && (
